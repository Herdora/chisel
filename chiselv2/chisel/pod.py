...
class Pod:
    ...
    env: Optional[Dict[str, str]] = None  # Environment variables as key-value string pairs
    ...
    portMappings: Optional[Dict[str, int]] = None  # Port number as string key, mapped port as int value
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Pod':
        ...
        if 'savingsPlans' in data and data['savingsPlans']:
            savings_plans = [SavingsPlan.from_dict(plan) for plan in data['savingsPlans']]
