...
class ProfileManager:
    ...
    def profile(self, vendor: str, target: str, pmc_counters: Optional[str] = None, gpu_type: Optional[str] = None) -> ProfileResult:
        ...
        try:
            ...
            if target_info.is_source_file:
                if target_info.file_path is None:
                    raise RuntimeError("Source file path is None - this should not happen")
    ...
    def _build_command(self, vendor: str, target_info: TargetInfo) -> str:
        ...
        if target_info.file_path is None:
            raise RuntimeError("File path is None - this should not happen for source files")
