...
from chisel.core.profile_manager import ProfileManager
    ...
    if shell:
        ...
        try:
            result = subprocess.run(
                [sys.executable, "-m", "chisel.cli.main", "--install-completion", shell],
                capture_output=True,
                text=True,
            )
        ...
        try:
            result = subprocess.run(
                [sys.executable, "-m", "chisel.cli.main", "--install-completion"],
                capture_output=True,
                text=True,
            )
